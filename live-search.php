    ...
    */
    ...
    $page_content = '';
    $page_content .= '<div class="w-full live_search relative h-full">';

    $page_content .= '  <label class="input w-full h-full">';
    ...
    $page_content .= '  <div class="flex absolute" style="top: 15px;">';
